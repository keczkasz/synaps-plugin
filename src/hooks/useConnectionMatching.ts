    ...
    try {
      ...
      const mockProfiles = [
        ...
        },
        {
          ...
          bio: 'Creative writer and book enthusiast from Paris',
          mood: 'Inspired',
          interests: ['Writing', 'French Literature', 'Books', 'Poetry', 'Philosophy'],
        ...
        },
        {
          ...
          bio: 'Mindfulness coach and personal development specialist from London',
          mood: 'Peaceful',
        ...
        },
        {
          ...
          bio: 'Travel enthusiast and food blogger exploring world cultures',
          mood: 'Joyful',
          interests: ['Travel', 'Food', 'Cultural Exploration', 'Photography', 'Cooking'],
          current_intentions: 'Sharing travel stories and discovering new cuisines',
          connection_goals: 'Cultural exchanges and foodie adventures',
          updated_at: new Date().toISOString()
        },
        {
          id: 'mock-5',
          ...
          bio: 'Philosopher and psychologist from Boston',
          mood: 'Reflective',
          interests: ['Philosophy', 'Psychology', 'Deep Conversations', 'Literature'],
